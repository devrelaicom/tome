...
use common::{Fixture, ToolEnv, fabricate_all_registry_models, has_global_enrolment, paths_for};
...
/// binary's layout. Duplicated locally because `common::cache_dir_for` takes a
