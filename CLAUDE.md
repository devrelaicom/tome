...
- **Current phase:** **Phase 6 shipped (v0.6.0)** — hooks + agents complete. All 5 USs + Polish feature-complete; a phase-wide 4-reviewer pass over the *assembled* surface applied (0 blockers, 2 majors, security clean); the v0.6.0 git tag + `cargo publish` + release-notes are reserved for user push (per the constitution). Phase 5 (v0.5.0) shipped 2026-05-27; Phase 4 (v0.4.0) 2026-05-26.
