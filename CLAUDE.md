...
- **Current phase:** Phase 2, User Story 5 — closing. `tome catalog update` now re-embeds changed skills + auto-disables orphans, and `tome reindex` ships (PRs #25–#27). Closeout in PR #28.
...
- **Codebase docs:** [`.sdd/codebase/`](./.sdd/codebase/) — all 8 documents refreshed 2026-05-13 against US5-complete source via `/sdd:map incremental`.
