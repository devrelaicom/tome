...
- **Current phase:** Phase 3 — planning complete, implementation pending. `spec.md`, `plan.md`, `research.md`, `data-model.md`, `contracts/`, `quickstart.md`, and the requirements checklist all landed on 2026-05-14. `/sdd:tasks` is the next step. **Phase 2 is closed; all 257 tests pass across 39 suites.**
