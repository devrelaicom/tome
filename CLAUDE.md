...
- **Current phase:** Phase 2, User Story 6 — closing. `tome status` (read-only doctor) + extended `tome --version` shipped (PRs #29–#30). Closeout in PR #31.
...
- **Codebase docs:** [`.sdd/codebase/`](./.sdd/codebase/) — all 8 documents refreshed 2026-05-13 against US6-complete source via `/sdd:map incremental`.
